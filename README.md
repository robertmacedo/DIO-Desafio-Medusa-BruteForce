...
Ação: Bloquear automaticamente o IP do atacante (negar tráfego via Iptables/Firewall) ao detectar um número excessivo de falhas de login em um curto período. Serviços Afetados: Todos.
